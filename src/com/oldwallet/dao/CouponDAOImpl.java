...
public class CouponDAOImpl implements CouponDAO {
	...
	private static final String GET_FUND_VALUES= "SELECT COUNT(C.COUPON_CODE) AS TOTAL_COUPON_COUNT ,(SELECT COUNT(C.COUPON_CODE)-SUM(F.REDEEMED_COUNT) FROM FUND_ALLOCATION F)AS REDEEMED_COUNT  FROM COUPONS C WHERE C.REDEEM_STATUS='NEW';";
