...
<head>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <h2>${status}</h2>
                                    <form name="uploadFile" id="uploadFile"  action = "/csvBulkUpload " method="post" enctype="multipart/form-data">

                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Upload Your File Here<span class="required">*</span>                            </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                                ...
                                                <button type="submit" id="redeem_button" class="btn btn-success hvr-grow">Upload File</button>
                                            </div>											
                                        </div>
                                    </form>
                                </div>
    ...
    <div id="slider2_container" style="position: relative; top: 0px; left: 0px; width: 600px;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px;
            overflow: hidden;">
            <div>
                <a u=image href="#"><img src="/images/add1.jpg" /></a>
            </div>
            <div>
                <a u=image href="#"><img src="/images/add2.jpg" /></a>
            </div>
            <div>
                <a u=image href="#"><img src="/images/add3.jpg" /></a>
            </div>
            <div>
                <a u=image href="#"><img src="/images/add4.jpg" /></a>
            </div>
            <div>
                <a u=image href="#"><img src="/images/add5.png" /></a>
            </div>
            <div>
                <a u=image href="#"><img src="/images/add6.jpg" /></a>
            </div>
            <div>
                <a u=image href="#"><img src="/images/add7.jpg" /></a>
            </div>
            <div>
                <a u=image href="#"><img src="/images/add8.jpg" /></a>
            </div>
        </div>
